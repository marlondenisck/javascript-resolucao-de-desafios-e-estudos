...
const my3FavoriteTVShows = ['Breaking Bad', 'Two and a Half Man', 'A Prova de Tudo']
const setence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows.join(', ')}.`.replace(', A', ' e A')
...
// console.log(crazyOperation, typeof crazyOperation)
// console.log(crazyConversion, typeof crazyConversion)
// null nao é nada(0) e somado a 1 recebeu um valor number e number é true!
