...
const initCounterButton = document.querySelector('.button-init-counter')
...
const initCounter = () => {
  ...
  initCounterButton.setAttribute('disabled', '')
}
...
const stopCounter = () => {
  ...
  counter = 0
  counterContainer.textContent = counter
  initCounterButton.removeAttribute('disabled', '')
}

initCounterButton.addEventListener('click', initCounter)
