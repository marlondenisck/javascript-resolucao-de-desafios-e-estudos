...
localStorage.setItem('myKey', JSON.stringify(myName))

const getItemStorage = keyName => {
  return JSON.parse(localStorage.getItem(keyName))
}

// console.log(getItemStorage('myKey'))
...
console.log(combineOperations(0, [add100, divByFive]))
