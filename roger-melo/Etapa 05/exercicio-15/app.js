...
const insertVideoClassLi = li => li.classList.add('video')

lis.forEach(insertVideoClassLi)
...
const insertVideoLi = ({ name }) => ul.innerHTML += `<li>${name}</li>`

const handleClickButton = () => videos.forEach(insertVideoLi)
...
h1.addEventListener('click', () => {
  childrens.forEach(element => element.remove())
})