...
console.log(`Fora do escopo de bloco ${myName}`)
...
showMyAge()
// variavel criada dentro de escopo se torna local e nao pode ser acessada globalmente
// console.log(myAge)
...
let car = {
  ...
  getColorsMessage() {
    const lastItem = this.colors.length -1
    const colors = this.colors.join(', ').replace(this.colors[lastItem], `e ${this.colors[lastItem]}`)
