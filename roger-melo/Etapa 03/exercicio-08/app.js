...
const log = function (value = 'Necessário repassar um paramêtro!') {
  console.log(value)
}
...
const trasnsformToUpperCase = function(array = []) {
  let newArray = []
...
const millenialWordsInUpperCase = trasnsformToUpperCase(millennialWords)
