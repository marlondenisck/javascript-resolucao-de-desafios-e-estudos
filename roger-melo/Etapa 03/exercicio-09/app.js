...
// console.log(getStringLength(convertToString('oito')))
...
const convertToStringLowerCase = (value) => {
  if (typeof value === 'string') {
    return value.toLowerCase()
  }
}

// console.log(convertToStringLowerCase("CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO"))
...
const getIndexInString = (char, str) => {
  if(typeof char && typeof str === 'string') {
   return str.indexOf(char)
  }
}

// console.log(getIndexInString('s', 'string'))
...
const invokedBolleanParam = (item, arr) => arr.includes(item)

// console.log(invokedBolleanParam(1, ['banana', null, 1, true]))
...
const concatTwoArrays = (arr1, arr2) => arr1.concat(arr2)
...
const removeLastItemInArray = (arr) => {
  arr.pop()
  return arr
}

// console.log(removeLastItemInArray([1, 2, 3, 4]))
...
const callFunctionCallback = (value, callback) => {
  return callback(value)
}

const triple = num => num * 3

// console.log(callFunctionCallback(33, triple))  
...
const showNumbersInfo = (item, index, array) => {
  ...
  console.log(`O ${firstItem}º item do array [${items}] é ${item}.`)
}
...
// console.log(lettersCopy !== letters)
...
const peoples = ['Rafael', 'Roger', 'Bianca', 'Jose', 'Maria', 'Jenifer']

console.log(getLikesMessage(peoples))