...
/*
  ...
  - Exiba no console quantos números menores que 501 o array abaixo possui.
*/

const crazyNumbers = [937, 5, 395, 402, 501, 333, 502, 781, 3, 691];

const countNumberLessThan501 = (acc, number) => number < 501 ? ++acc : acc;

const numbersLessThan501 = crazyNumbers.reduce(countNumberLessThan501, 0);

console.log(crazyNumbers, `existe ${numbersLessThan501} menores que 501`);
...
const newMovies = tarantinoMovies.filter(({release}) => release < 2000);

console.log(tarantinoMovies,  newMovies);
...
const showNamesTv = tvShows.map(({name}) => name);

console.log(tvShows, showNamesTv)
