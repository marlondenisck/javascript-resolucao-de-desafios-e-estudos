...
const lastItemArray = strings[strings.length -1]
const insertStrings = strings.join(', ').replace(`, ${lastItemArray}`, ` e ${lastItemArray}`)


console.log(`3 informações sobre o array randomValues:
- As primeiras 4 strings são ${insertStrings};
- Até que as primeiras 4 strings fossem iteradas, ${boleansAmount} booleans foram iterados;
