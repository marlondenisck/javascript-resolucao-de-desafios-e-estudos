...
const paresString = pares.join(', ').replace(', 5', ' e 5')
const imparesString = impares.join(', ').replace(', 3', ' e 3')

console.log(`Numeros ímpares: ${imparesString}. Números pares: ${paresString}.`)
