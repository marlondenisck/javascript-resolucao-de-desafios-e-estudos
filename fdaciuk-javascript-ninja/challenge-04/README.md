...
carro.adicionarPessoasNoCarro = function(nPessoas) {
  var total = carro.quantidadePessoas + nPessoas;
  ...
  if (total > carro.assentos) {
    var quantoasPessoasCabem = carro.assentos - carro.quantidadePessoas;
    var pluralOuSingular = quantoasPessoasCabem === 1 ? 'pessoa' : 'pessoas';
    return `Só cabem mais ${quantoasPessoasCabem} ${pluralOuSingular}`;
  }
