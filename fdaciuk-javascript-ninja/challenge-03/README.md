...
pessoa.andar = function(qtdMetros) {
  pessoa.caminhouQuantosMetros = pessoa.caminhouQuantosMetros + qtdMetros;
  pessoa.andando = true;
}
...
*/
pessoa.nomeCompleto() // 'Olá! Meu nome é Marlon Authority!'

/*
Qual a idade da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarIdade() // 'Olá, eu tenho 27anos!'
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura() //'Minha altura é 1.74cm.
...
retornada)
*/
 pessoa.mostrarIdade(); // 'Olá, eu tenho 30anos!'
...
// Agora, apresente-se ;)
pessoa.apresentacao() // 'Olá, eu sou o Marlon Authority, tenho 30 anos, 1.74 de altura, meu peso é 62kg e, só hoje, eu já caminhei 10 metros!'
```
