(function(){  
  ...
  */
  ...
  var sudeste = ['São paulo', 'Rio de janeiro', 'Minas gerais'];
  ...
  */
  ...
  brasil.unshift('Acre', 'Manaus', 'Amazonas');
  console.log(brasil);
  ...
  */
  var nordeste = ['Ceará', 'Pernanbuco', 'Alagoas', 'Bahia'];
  ...
  */
  ...
  chamada `newSudeste`.
  */
  var newSudeste = brasil.splice(5, 3);
